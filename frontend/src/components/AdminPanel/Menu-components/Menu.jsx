        ...
        <>
            <style>
                ...
                .custom-scrollbar::-webkit-scrollbar-track {
                    background: #2d2f40; /* Background color of the scrollbar track */
                }
                .custom-scrollbar::-webkit-scrollbar-thumb {
                    background: #4b4f68; /* Color of the scrollbar thumb */
                    border-radius: 4px; /* Rounded corners for the scrollbar thumb */
                }
                .custom-scrollbar::-webkit-scrollbar-thumb:hover {
                    background: #5d6180; /* Color of the scrollbar thumb on hover */
                }
                `}
            </style>
            <div className="container mx-auto mt-4 p-4 w-[1000px] bg-[rgb(16,20,34)] rounded-lg shadow-lg">
                ...
                <div
                    className="overflow-x-auto border border-black custom-scrollbar shadow-2xl"
